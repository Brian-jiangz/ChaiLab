    ...
    'jiang-zheng': {
        'zh': {
            ...
            'exp': [
                ...
                ('2019.06–2022.06', '中国地质大学（武汉）海洋地质资源湖北省重点实验室（科研训练）', '基于 CMIP6 海平面高度模式数据研究北大西洋及北太平洋亚热带、亚极地涡旋移动；通过经验正交函数与小波分析等方法研究 1850–2019 年全球海表温度时空变化规律及异常。'),
                ('2021.04', '中山大学 海洋科学学院', '访问学生'),
                ('2019.07–08', '厦门大学 近海海洋环境国家重点实验室', '访问学生：诊断分析原绿球藻时空分布规律，预测全球气候变暖下原绿球藻的未来分布特征。'),
            ...
            'awards': [
                '中国地质大学（武汉）"李四光计划"入选者（全校入选率 < 0.7%，2019）',
                '中国科学院大学 三好学生（2024）',
                '中国科学院大学 一、二等奖学金（2023、2024）',
                '中国地质大学（武汉）优秀毕业生、优秀毕业论文（2022）',
                '中国地质大学（武汉）院士奖学金（2022）',
                'MCM 数学建模竞赛 Meritorious Winner（全球前 6%，2021）',
                'Mathorcup 数学建模大赛全国三等奖（2021）',
                '全国大学生数学建模大赛省级三等奖（2020）',
                '"挑战杯"大学生创业计划大赛省级银奖（负责人，2020）',
                '"互联网+"创新创业大赛校级二等奖（负责人，2020）',
                '"创青春"创业计划大赛校级一等奖（负责人，2020）',
                '周大福奖学金（2019、2020）',
            ],
            'conf': [
        ...
        'en': {
            ...
            'exp': [
                ...
                ('2019.06\u20132022.06', 'Hubei Key Laboratory of Marine Geological Resources, CUG (Wuhan)', 'Studied subtropical/subpolar gyre migration in the North Atlantic and North Pacific using CMIP6 sea-level data; analyzed global SST variability and anomalies during 1850\u20132019 via EOF and wavelet analysis.'),
                ('2021.04', 'School of Marine Sciences, Sun Yat-sen University', 'Visiting student'),
                ('2019.07\u201308', 'State Key Laboratory of Marine Environmental Science, Xiamen University', 'Visiting student: diagnosed the spatiotemporal distribution of Prochlorococcus and predicted its future distribution under global warming.'),
            ...
            'awards': [
                'Selected into the "Li Siguang Program", CUG (Wuhan) (admission rate < 0.7%, 2019)',
                'Merit Student, University of Chinese Academy of Sciences (2024)',
                'First & Second-Class Scholarships, UCAS (2023, 2024)',
                'Outstanding Graduate & Outstanding Thesis, CUG (Wuhan) (2022)',
                'Academician Scholarship, CUG (Wuhan) (2022)',
                'MCM Meritorious Winner (top 6% worldwide, 2021)',
                'National Third Prize, Mathorcup Mathematical Modeling Competition (2021)',
                'Provincial Third Prize, National College Mathematical Modeling Competition (2020)',
                'Provincial Silver Award, "Challenge Cup" Entrepreneurship Competition (leader, 2020)',
                'Cheng Chuang Award, "Internet+" Innovation Competition (leader, 2020)',
                'Chow Tai Fook Scholarship (2019, 2020)',
            ],
            'conf': [
